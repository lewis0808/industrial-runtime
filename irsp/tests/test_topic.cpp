...
int main() {
    ...
    IR_CHECK(eq(trie.match("factory1/line1/robot1/temp"), std::vector<std::uint64_t>{1, 3, 4}));
    IR_CHECK(eq(trie.match("factory1/lineA/temp"), std::vector<std::uint64_t>{1, 2, 4}));
